...
Constrain the first canvas release to `image` and `text` nodes, baseline infinite-canvas interaction, Tiptap-based AI chat entry, and placing AI-generated images on the canvas.
