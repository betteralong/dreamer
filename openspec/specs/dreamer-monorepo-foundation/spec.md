# Dreamer monorepo foundation

## Purpose

Define the monorepo layout (`apps/web`, `apps/api`, `packages/shared`), root-level workspace tooling for independent or combined dev workflows, and shared contracts consumable by both apps.
