# Structured chat parts

## Purpose

Define the structured chat input model for MVP: `Part[]` kinds (`text`, `media`, `input`, `select`), inline editing behavior, and serialization to prompt-compatible text including media fallbacks.
